// Reprocess runs 14 (HomeVision), 15 (JOC), 16 (BOC) after the
// Shah Hassan / Akash HR ruling (2026-09-13). Run 12 (Trusoft) and 13
// (Homenet) are untouched by the ruling — verified byte-stable afterwards.
