// tests/unit/mcp/auditTrail.tools.scenarios.test.js
//
// Per-tool scenario matrix for HR audit trail tools (1 tool).
// DB-free: service is mocked; tool→service dispatch + gate is asserted.
import { jest, describe, it, expect, beforeEach } from '@jest/globals';

jest.unstable_mockModule('../../../src/services/auditTrail.service.js', () => ({
  getAuditTrail: jest.fn(async () => ({ success: true })),
}));

const { registerAuditTrailTools } = await import('../../../src/mcp/tools/auditTrailTools.js');
...
registerAuditTrailTools(recording);
...
const TOOLS = [
  { name: 'hr_audit_trail_list', gate: 'hr:compliance', action: 'VIEW', args: {} },
];

describe('AUDIT-TRAIL-SCENARIOS — registration', () => {
