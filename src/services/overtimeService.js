...
export async function updateOvertimeRule(id, data) {
...
export async function deleteOvertimeRule(id) {
    const rule = await prisma.overtimeRule.findUnique({
        where: { id: parseInt(id) }
    });
...
export async function calculateOvertime({ employeeId, periodStart, periodEnd }) {
